...
> 📚 **系列导航**：上一篇 [34 CLI 参考手册：命令与全部标志] 帮你把「启动 Claude 之前」能拨的开关查全了。这一篇换到「会话已经开起来」之后——你跟 Claude 一来一回的过程里，手里其实攥着一整块「控制台」：怎么按一下就让它换工作模式、怎么让它先出方案别急着动手、怎么花钱换更快的响应、怎么用 Vim 手势编辑你的输入。**[第 20 篇](20-permissions.md)讲过权限那根缰绳，这一篇讲你手上的全套操纵杆。**
