...
这里穿插一个**它帮你做对的目录结构**。官方文档给的 skill 标准长相是这样的：
...
**预期**：列表里能看到 `skill-creator`。看不到的话，回第 02 节按那两条 `/plugin` 命令装一下（记得开魔法上网）。
...
| 你要做的事 | 用什么 | 关键点 |
|-----------|--------|--------|
| 装造 skill 的工具 | `/plugin install skill-creator` | 从官方插件市场装，需魔法上网 |
