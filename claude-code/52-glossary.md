...
> 📚 **系列导航**：上一篇 [51 常见问题排查（FAQ / Troubleshooting）](51-faq-troubleshooting.md) 把你最容易卡住的报错和怪现象挨个排雷。这一篇做一件更基础、也更该早做的事——**把全教程冒出来过的术语，一个一个翻成人话**。代理循环、上下文窗口、MCP、subagent、skill、hook、checkpoint、权限模式、headless、transport……五十多篇下来名词攒了一大堆，这一篇当你的随身速查卡，**哪个词糊了，回来一翻就清楚**。
