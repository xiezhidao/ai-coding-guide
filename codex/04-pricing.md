...
**Pro（从 \$100 起）的卖点就一个：限额大幅提升。** 官方写得很直白——Pro 提供「比 Plus 高 5 倍或 20 倍」的 Codex 用量，外加一个面向日常编码的快速模型（研究预览阶段）。**说白了就是 Plus 撞限额撞烦了、又不想买积分续命的人，直接上 Pro。** 我自己在那次重构触顶后纠结过要不要升 Pro，最后没升——因为靠下一节那套省 token 的习惯，Plus 又够用了。**先学会省，再考虑升档。**
